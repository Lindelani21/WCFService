<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="registration.aspx.cs" Inherits="AG_webD2.registration" %>
...
<body>
    <div class="container">
        <h1>Register</h1>
        <form action="registration.aspx" method="post" runat="server" id="formId">
